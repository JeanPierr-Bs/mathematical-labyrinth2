...
public class CustomPhysicsObject : MonoBehaviour
{
    ...
    // Debug visual para los rayos
    void OnDrawGizmosSelected()
    {
        Gizmos.color = Color.blue;
        Gizmos.DrawRay(transform.position, Vector3.forward * wallCheckDistance);
        Gizmos.DrawRay(transform.position, Vector3.back * wallCheckDistance);
